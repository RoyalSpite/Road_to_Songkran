...
public class ShopSpawner : MonoBehaviour
{
    ...
    [SerializeField]private float shopSpawnDistance = 60f; // 1 กิโลเมตร หรือ 1000 หน่วย
    [SerializeField]private float signSpawnDistance = 50f; // 0.5 กิโลเมตร หรือ 500 หน่วย
